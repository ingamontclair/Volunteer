...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 15 23:44:19 2018

@author: priyankaphapale
"""
# Changed the existing script with our requirements.
...
file = open(os.path.expanduser(r"/Users/priyankaphapale/Documents/WeatherData_CityName.csv"), "wb")
file.write(
...
for vYear in range(2004, 2018):
    for vMonth in range(1, 13):
        for vDay in range(1, 32):
            ...
            theurl = "http://www.wunderground.com/history/airport/city_code/" + theDate + "/DailyHistory.html"
